          ...
          <div className="bg-[var(--admin-card-bg)] rounded-app p-8 border border-[var(--admin-border)] relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <CustomSelect
                  options={[
                    { value: "amount", label: "Fixed Amount", icon: <DollarSign size={14} /> },
                    { value: "percentage", label: "Percentage OFF", icon: <Percent size={14} /> }
                  ]}
                ...
                <div className="relative">
                  <CustomSelect
                    options={cars.map(car => ({
                      ...
                      label: `${car.brand?.name || car.brand || 'Car'} ${car.model} (${car.year})`
                    }))}
                    placeholder="-- Add Applicable Cars --"
                    onChange={val => {
                ...
                <div className="relative">
                  <CustomSelect
                    options={users.map(user => ({
                      ...
                      label: `${user.displayName || `${user.firstName || ''} ${user.lastName || ''}`.trim() || user.email} (${user.email})`
                    }))}
                    placeholder="-- Add Restrained Users --"
                    onChange={val => {
