  ...
  return (
    <div className="min-h-screen bg-background font-sans selection:bg-primary selection:text-white">
      ...
      <section className="relative pt-20 min-h-screen flex items-center overflow-hidden">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 w-full py-20 flex flex-col lg:flex-row items-center gap-12">
          ...
          >
            ...
            >
              Your Ride Should Match the Road!
            </motion.h1>
            <motion.p
              variants={fadeInUp}
              className="text-lg md:text-xl text-white/80 max-w-lg drop-shadow"
            >
              Book your luxury drive in just a few clicks. Experience the ultimate comfort and performance on your next journey.
            </motion.p>
      ...
      <section className="py-24 max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
          <div>
            <h2 className="text-4xl font-bold mb-4 text-foreground">Drive Destinations</h2>
            <p className="text-muted-foreground max-w-2xl">Curated routes for the ultimate driving experience.</p>
          </div>
        </div>
      ...
      <section className="py-24 bg-muted/30 border-y border-border/50">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <motion.p variants={fadeInUp} className="text-primary font-semibold tracking-wider uppercase text-sm mb-3">What Our Clients Say</motion.p>
            <motion.h2 variants={fadeInUp} className="text-4xl font-bold mb-4 text-foreground">Trusted by Thousands</motion.h2>
            <motion.p variants={fadeInUp} className="text-muted-foreground max-w-2xl mx-auto">Real stories from real CarRentify clients around the world.</motion.p>
          </motion.div>
      ...
      <section className="py-16 max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <motion.div
            ...
            className="relative rounded-3xl overflow-hidden p-8 flex items-center justify-between gap-6 min-h-[220px]"
            style={{ background: "linear-gradient(135deg, #b3d8f7 0%, #89c4ef 100%)" }}
          >
            <div className="flex-1 z-10">
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Finding Your Ideal Match?</h3>
              <p className="text-gray-700 text-sm mb-6 max-w-[220px]">
                Explore options for your next vehicle. Compare, decide, and connect to find the perfect ride for your journey.
              </p>
              <Button className="bg-primary hover:bg-primary-hover text-white rounded-full px-6 h-11 font-semibold flex items-center gap-2" data-testid="button-explore-options">
                Explore Options <ChevronRight className="w-4 h-4" />
              </Button>
            </div>
            <div className="w-[180px] shrink-0">
              <img src="/car-5.png" alt="Find your match car" className="w-full object-contain drop-shadow-xl" />
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="relative rounded-3xl overflow-hidden p-8 flex items-center justify-between gap-6 min-h-[220px]"
            style={{ background: "linear-gradient(135deg, #f9e87b 0%, #f5d842 100%)" }}
          >
            <div className="flex-1 z-10">
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Managing Your Car Journey?</h3>
              <p className="text-gray-700 text-sm mb-6 max-w-[220px]">
      ...
      <section className="py-24 bg-primary text-primary-foreground relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 flex flex-col lg:flex-row gap-12 items-center">
          <div className="lg:w-1/3">
            <h2 className="text-4xl font-bold mb-6">Find us globally</h2>
            <p className="text-primary-foreground/80 mb-8 text-lg">We have premium locations in all major cities and airports across the globe, ensuring you are never far from your next luxury drive.</p>
            ...
            <Button variant="outline" className="mt-10 border-white text-primary bg-white hover:bg-white/90 rounded-full px-8">
              View All Locations
            </Button>
          </div>
      ...
      <section className="py-24 max-w-7xl mx-auto px-6">
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-1/2">
            <h2 className="text-4xl font-bold mb-6 text-foreground">Enhance Your Experience</h2>
            <p className="text-muted-foreground mb-10 text-lg">Find premium accessories and book exclusive services to make your journey truly unforgettable.</p>
          ...
          <div className="lg:w-1/2">
            <div className="w-full h-full min-h-[400px] rounded-3xl overflow-hidden">
              <img src="/enhance.png" alt="Luxury Accessories" className="w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="bg-primary rounded-[3rem] overflow-hidden relative shadow-2xl flex flex-col lg:flex-row items-center">
            <div className="lg:w-1/2 p-12 lg:p-20 relative z-10">
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">Get the Drive App</h2>
              <p className="text-white/80 mb-10 text-lg">Download the app and find your perfect drive instantly. Manage bookings, unlock cars directly, and access 24/7 premium support.</p>
            ...
            <div className="lg:w-1/2 relative w-full flex items-end justify-center lg:justify-end h-[320px] md:h-[450px] lg:h-[600px] overflow-hidden px-8 lg:px-0">
              <img src="/app-mockup.png" alt="App Mockups" className="w-auto h-full max-w-none object-contain object-bottom transform lg:translate-y-16 lg:translate-x-12 lg:scale-110" />
            </div>
          </div>
        </div>
      </section>
