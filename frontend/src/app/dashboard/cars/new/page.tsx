  ...
  const validateStep = (step: number) => {
    ...
    if (firstErrorId) {
      const idMap: Record<string, string> = {
        name: "name-input", brand: "brand-select", model: "model-input", year: "year-select", type: "type-select", images: "visual-repository", address: "location-module", city: "location-module"
      };
