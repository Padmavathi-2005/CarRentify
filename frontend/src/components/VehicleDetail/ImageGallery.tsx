...
export const ImageGallery = ({ 
 ...
 <div className="absolute top-8 left-8 flex flex-col gap-3 z-40 pointer-events-none">
 ...
 className={`w-12 h-12 rounded-app flex items-center justify-center transition-all bg-black/20 backdrop-blur-md border border-white/20 group/save ${isFavorite ? 'bg-white text-rose-500 -500/20' : 'text-white hover:bg-white hover:text-rose-500'}`}
 >
 <Heart size={20} className={isFavorite ? "fill-rose-500" : "group-hover/save:scale-110 transition-transform duration-300"} />
 </button>
 <button
 onClick={(e) => { e.stopPropagation(); onShare(); }}
 className="w-12 h-12 rounded-app flex items-center justify-center transition-all bg-black/20 backdrop-blur-md border border-white/20 text-white hover:bg-white hover:text-primary group/share"
 >
 ...
 className="absolute left-6 top-1/2 -translate-y-1/2 w-14 h-14 rounded-full bg-slate-900/40 backdrop-blur-xl border border-white/20 text-white flex items-center justify-center opacity-70 hover:opacity-100 transition-all hover:scale-110 active:scale-90 z-30"
 >
 <ChevronLeft size={32} />
 </button>
 <button
 ...
 className="absolute right-6 top-1/2 -translate-y-1/2 w-14 h-14 rounded-full bg-slate-900/40 backdrop-blur-xl border border-white/20 text-white flex items-center justify-center opacity-70 hover:opacity-100 transition-all hover:scale-110 active:scale-90 z-30"
 >
